  ...
  <body>
      <form method="post" action="{{route('products.store')}}">
          ...
          <div class="form-group">
            ...
            <input id="my-input" class="form-control" type="text" name="suppler_company" id="suppler_company">
          </div>
          <div class="form-group">
            <label for="my-input">please enter count</label>
            <input id="my-input" class="form-control" type="text" name="count" id="count">
          </div>
          <div class="form-group">
            <label for="my-input">please enter cost</label>
            <input id="my-input" class="form-control" type="text" name="cost" id="cost">
          </div>
